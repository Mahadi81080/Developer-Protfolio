...
const AboutSection = () => {
  return (
    <div>
      <div className="flex flex-col md:flex-row lg:flex-row justify-between bg-[#1b1e26]">
        <div className="w-full flex justify-between items-center ">
          <img src={img} alt="" className=" bg-[#ccbeb5]" />
        </div>
        <div className="md:w-4/12 lg:w-4/12 space-y-6 bg-[#de622f] text-white px-10 pb-4 mt-10">
